...
from src.networks.othello_network import OthelloNetwork

# MAKE SURE THESE CONSTANTS ARE IN SYNC WITH constants.hpp
# MAKE SURE THE RUN NAME IS IN SYNC WITH OTHWorker.cpp
...
UCT_ITERATIONS = 32768
MAX_TRAVERSALS = 8
MAX_QUEUE_SIZE = 4

INIT_NUM_GAMES_PER_WORKER = 3
INIT_UCT_ITERATIONS = 262144
