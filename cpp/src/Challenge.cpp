...
int main(int argc, char* argv[]) {
    if (argc != 7) {
        ...
        // example: ./Challenge ~/sprl/data/models/panda_gamma_slower/traced_panda_gamma_slower_iteration_189.pt ~/sprl/data/configs/panda_gamma_slower_config_uct.json 0 2048 8 16
        return 1;
    }
