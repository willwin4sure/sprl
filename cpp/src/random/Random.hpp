#ifndef SPRL_RANDOM_HPP
#define SPRL_RANDOM_HPP
...
private:
    /**
     * Implementation based on 32-bit PCG random:
...
/**
 * Singleton pattern for Random objects.
 * 
 * @returns A reference to a static Random object.
*/
Random& GetRandom();
